 ...
 * ═══════════════════════════════════════════════════════════════════════════
 * 
 * Transforma TODA la configuración de Google Sheets en contexto rico para Tan • IA.
 * 
 * PRINCIPIOS:
...
/**
 * Formatea la configuración completa para inyectar en el prompt de Tan • IA
 * 
...
export function formatConfigForLLM(config) {
  ...
  if (config.persona) {
    ...
    identitySection += `Eres **${p.agent_name || 'Tan • IA'}${p.agent_suffix ? ` ${p.agent_suffix}` : ''}**, asistente virtual de ${config.brand?.brand_name || 'Tagers'}.\n`;
